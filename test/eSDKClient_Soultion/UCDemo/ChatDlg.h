...
public:
	...
	afx_msg void OnBnClickedButtonStopRecord();	//停止录音
	...
	afx_msg void OnClickListContMenuItem(UINT uID);						//右击菜单选择逻辑处理
...
public:
	...
	void MemCopy(char* dest, const CString& str, size_t size);
