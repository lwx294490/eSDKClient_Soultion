...
public:
	bool m_bHaveJoin;						//标志位，是否已加入预约会议
	std::string m_convId;					//加入的预约会议会话ID
	UCSDKBookConfList m_UCSDKBookConfList;	//本地存放预约会议列表
	CDialog* m_pCBaseDlg;					//父窗口指针，CBaseDlg
