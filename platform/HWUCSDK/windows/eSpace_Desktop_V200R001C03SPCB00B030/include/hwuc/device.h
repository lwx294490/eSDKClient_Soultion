...
public:
  ...
  * \return  true:  success ; false: failed 
  */ 
  virtual bool BeginPlayFile(const std::string& _file, bool _loop) = 0;
...
public:
  ...
  */ 
  ...
  virtual bool SetVideoDecodeFrameRate(const std::string decodeFramerate) = 0;
