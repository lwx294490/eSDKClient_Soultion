...
namespace ctk {
    ...
    namespace xml
    {
        ...
        const xstring XML_TAG_CDATA_BEG = xstring("<![CDATA[");
        const xstring XML_TAG_CDATA_END = xstring("]]>");

        const xstring XML_TAG_COMMENT_BEG = xstring("<!--");
        const xstring XML_TAG_COMMENT_END = xstring("-->");
        const xstring XML_TAG_DIRECTIVE_BEG = xstring("<?");
        const xstring XML_TAG_DIRECTIVE_END = xstring("?>");

        const xstring INDENT_STR = xstring("    ");
        const xstring NEWLINE_STR = xstring("\n");
