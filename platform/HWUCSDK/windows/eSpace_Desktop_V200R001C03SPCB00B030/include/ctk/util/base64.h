...
namespace ctk
{
    ...
    public:
        ...
        CTK_STATIC_FUN void encode(istr _bin, String& _txt, bool _insertNewLines=true);
        CTK_STATIC_FUN void encode(const ByteVector& _bin, String& _txt, bool _insertNewLines=true);
